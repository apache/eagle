...
public class HadoopServiceCheckAppProviderTest extends ApplicationTestBase {
    ...
    public void testApplicationLifecycle() throws InterruptedException {
        ...
        siteEntity.setDescription("Test Site for HADOOP_HEALTHCHECK_APP");
        siteResource.createSite(siteEntity);
        Assert.assertNotNull(siteEntity.getUuid());

        ApplicationOperations.InstallOperation installOperation = new ApplicationOperations.InstallOperation("test_site", "HADOOP_HEALTHCHECK_APP", ApplicationEntity.Mode.LOCAL);
