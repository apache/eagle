...
public class MapDataSkewFunc extends AbstractDataSkewFunc {

    public MapDataSkewFunc() {
        super(JobCounters.CounterName.HDFS_BYTES_READ, Constants.SuggestionType.MapDataSkew);
    }
