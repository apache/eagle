...
/**
 * Context Object for Email
 */
public class EmailContext {

    private List<EmailComponent> components;
    ...
    public List<EmailComponent> getComponents() {
        return components;
    }
    public void setComponents(List<EmailComponent> components) {
