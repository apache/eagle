...
public class KafkaProducerTest1 implements Serializable {
    ...
    public void producerTestOozie() throws InterruptedException, JsonProcessingException, ParseException {
        ...
        //    starttime = DateUtils.addSeconds(new Date(starttime), 3).getTime();
       ...
       /* map2.put("ip", "xxx.xxx.xxx.xxx");
        ...
        while (true) {
            try {
                ...
                map2.clear();
                //  starttime = DateUtils.addSeconds(new Date(starttime), 3).getTime();
                map1.put("jobId", "140648764-oozie-oozi-W" + DateTimeUtil.format(starttime, "yyyy-MM-dd HH:mm:ss"));
                map1.put("ip", "yyy.yyy.yyy.yyy");
                map1.put("operation", "start");
                ...
                map2.put("ip", "xxx.xxx.xxx.xxx");
                map2.put("jobId", "150648764-oozie-oozi-W" + DateTimeUtil.format(starttime, "yyyy-MM-dd HH:mm:ss"));
                map2.put("operation", "end");
...
//        ZkUtils zkUtils = new ZkUtils(zkClient, zkConnection, false);
        ...
        AdminUtils.createTopic(zkClient, "oozie_audit_log_enriched", 3, 1, topicConfiguration);
    }
