...
//
//import eagle.common.config.EagleWebConfigManager;
//
///**
...
//
//	private final List<CounterGroupKey> groupKeys = new ArrayList<CounterGroupKey>();
//
//	private static volatile CounterGroupDictionary instance = null;
//	private static final Logger LOGGER = LoggerFactory.getLogger(CounterGroupDictionary.class);
//
//	private CounterGroupDictionary() {}
//
//	public static CounterGroupDictionary load() throws JobCounterException {
//		if (instance == null) {
...
//		InputStream is = EagleWebConfigManager.class.getClassLoader().getResourceAsStream("/JobCounter.conf");
//		try {
//			if (is == null) {
//				is = EagleWebConfigManager.class.getClassLoader().getResourceAsStream("JobCounter.conf");
//				if (is == null) {
