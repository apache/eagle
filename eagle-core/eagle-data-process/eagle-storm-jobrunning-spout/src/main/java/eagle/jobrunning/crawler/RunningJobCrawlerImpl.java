...
import eagle.jobrunning.common.JobConstants.YarnApplicationType;
import eagle.jobrunning.config.RunningJobCrawlConfig;
import eagle.jobrunning.config.RunningJobCrawlConfig.ControlConfig;
import eagle.jobrunning.config.RunningJobCrawlConfig.RunningJobEndpointConfig;
...
public class RunningJobCrawlerImpl implements RunningJobCrawler{
	...
	protected RunningJobEndpointConfig endpointConfig;
