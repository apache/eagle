...
public class EagleFilterParser extends Parser {
    ...
    public static final int DOUBLEQUOTED_STRING = 12;
    public static final int LPAREN = 13;
    public static final int RPAREN = 14;
    public static final int LBRACE = 15;
    public static final int RBRACE = 16;
    public static final int RULE_filter = 0;
    public static final int RULE_combine = 1;
    public static final int RULE_equation = 2;
    ...
    public static class FilterContext extends ParserRuleContext {
        ...
        public TerminalNode eof() {
            return getToken(EagleFilterParser.EOF, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof EagleFilterListener) {
                ((EagleFilterListener) listener).enterFilter(this);
            }
        }
        ...
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof EagleFilterListener) {
                ((EagleFilterListener) listener).exitFilter(this);
            }
        }
    }
    ...
    public static class CombineContext extends ParserRuleContext {
        public TerminalNode lparen() {
            return getToken(EagleFilterParser.LPAREN, 0);
        }
        ...
        public TerminalNode rparen() {
            return getToken(EagleFilterParser.RPAREN, 0);
        }
        ...
        public TerminalNode and() {
            return getToken(EagleFilterParser.AND, 0);
        }

        public TerminalNode or() {
            return getToken(EagleFilterParser.OR, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof EagleFilterListener) {
                ((EagleFilterListener) listener).enterCombine(this);
            }
        }
        ...
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof EagleFilterListener) {
                ((EagleFilterListener) listener).exitCombine(this);
            }
        }
    }
    ...
    private CombineContext combine(int precedence) throws RecognitionException {
        ParserRuleContext _parentctx = _ctx;
        int _parentState = getState();
        CombineContext _localctx = new CombineContext(_ctx, _parentState);
        CombineContext _prevctx = _localctx;
        int _startState = 2;
        enterRecursionRule(_localctx, 2, RULE_combine, precedence);
        try {
            int _alt;
            enterOuterAlt(_localctx, 1);
            {
    ...
    public static class EquationContext extends ParserRuleContext {
        public List<TerminalNode> value() {
            return getTokens(EagleFilterParser.VALUE);
        }
        ...
        public TerminalNode op() {
            return getToken(EagleFilterParser.OP, 0);
        }

        public TerminalNode id() {
            return getToken(EagleFilterParser.ID, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof EagleFilterListener) {
                ((EagleFilterListener) listener).enterEquation(this);
            }
        }
        ...
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof EagleFilterListener) {
                ((EagleFilterListener) listener).exitEquation(this);
            }
        }
    }
    ...
    public boolean sempred(RuleContext localctx, int ruleIndex, int predIndex) {
        switch (ruleIndex) {
            case 1:
                return combine_sempred((CombineContext) localctx, predIndex);
            default:
        }
        return true;
    }

    private boolean combine_sempred(CombineContext localctx, int predIndex) {
        switch (predIndex) {
            case 0:
