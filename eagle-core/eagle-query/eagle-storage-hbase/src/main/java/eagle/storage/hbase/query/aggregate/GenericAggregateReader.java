 ...
 */
package eagle.storage.hbase.query.aggregate;

import eagle.log.entity.AbstractHBaseLogReader;
import eagle.log.entity.meta.EntityDefinition;
import eagle.query.aggregate.AggregateCondition;
import eagle.storage.hbase.query.coprocessor.impl.AggregateClientImpl;
import eagle.query.aggregate.raw.GroupbyKeyValue;
import eagle.storage.hbase.query.coprocessor.AggregateClient;
import eagle.storage.hbase.query.coprocessor.AggregateResult;
...
public class GenericAggregateReader extends AbstractHBaseLogReader<List<GroupbyKeyValue>> {
	 ...
	 *
	 * @see eagle.query.aggregate.AggregateCondition
	 */
