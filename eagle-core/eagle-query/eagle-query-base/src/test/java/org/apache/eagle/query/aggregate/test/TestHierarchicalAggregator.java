...
public class TestHierarchicalAggregator {
    ...
    public void testZeroGropubyFieldHierarchicalAggregator() {
        ...
        try {
            ...
            Assert.assertEquals(result.getValues().get(0), (double) (entities[0].getNumHosts() + entities[1].getNumHosts() + entities[2].getNumHosts() + entities[3].getNumHosts() + entities[4]
                .getNumHosts()), 0.0001);
    ...
    public void testSingleGropubyFieldHierarchicalAggregator() {
        ...
        try {
            ...
            writeToJson("After aggregate", result);
            Assert.assertEquals(result.getChildren().size(), 2);
            Assert.assertEquals(result.getChildren().get("dc1").getValues().get(0), (double) (entities[0].getNumHosts() + entities[1].getNumHosts() + entities[3].getNumHosts() + entities[4]
                .getNumHosts()), 0.0001);
