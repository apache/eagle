...
object StormApplicationManagerSpec extends App {
  val manager: ApplicationManager = new StormApplicationManager
  val topologyDescModel = new TopologyDescriptionModel("testTopo", "org.apache.eagle.security.hbase.HbaseAuditLogProcessorTopology", "", "CLASS", "", "")
