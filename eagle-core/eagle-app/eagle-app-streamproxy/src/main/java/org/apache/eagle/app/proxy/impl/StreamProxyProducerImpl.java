...
public class StreamProxyProducerImpl implements StreamProxyProducer {
    private final Producer producer;

    public StreamProxyProducerImpl(String streamId, KafkaStreamSinkConfig config) {
    ...
    @Override
    public Future<Boolean> send(List<StreamRecord> events) throws IOException {
        return null;
    }
