...
//public abstract class StormApp<Conf extends ApplicationConfig> implements Application<StormTopology,Conf>,Serializable {

    //    private final static Logger LOG = LoggerFactory.getLogger(StormApp.class);
