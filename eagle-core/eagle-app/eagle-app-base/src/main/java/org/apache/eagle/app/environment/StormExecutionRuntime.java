...
public class StormExecutionRuntime implements ExecutionRuntime {
    ...
    private Config mergeAppConfig(Map<String,Object> appConfig, Config envConfig){
...
//        StormTopology topology = builder.createTopology();
        // TODO: think about Storm Environment
        StormTopology topology = (StormTopology) context.getApplication().execute(context.getFinalConfig(),new StormEnvironment());
