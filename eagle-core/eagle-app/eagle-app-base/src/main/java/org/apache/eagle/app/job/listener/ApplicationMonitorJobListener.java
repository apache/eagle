...
public class ApplicationMonitorJobListener implements JobListener {
    private static final Logger LOGGER = LoggerFactory.getLogger(ApplicationMonitorJobListener.class);
