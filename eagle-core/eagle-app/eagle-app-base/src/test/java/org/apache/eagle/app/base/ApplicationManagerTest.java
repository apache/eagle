...
public class ApplicationManagerTest {
    @Test
    public void testBasicUnmarshal() throws JAXBException {
        JAXBContext jc = JAXBContext.newInstance(ApplicationsConfig.class);
        Unmarshaller unmarshaller = jc.createUnmarshaller();
        InputStream is = ApplicationManagerTest.class.getResourceAsStream("/applications.xml");
    ...
    @Test
    public void testApplicationManagerLoad(){
