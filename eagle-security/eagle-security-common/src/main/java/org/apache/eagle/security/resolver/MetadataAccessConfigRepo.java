...
public class MetadataAccessConfigRepo {
    ...
    public Configuration getConfig(String application, String siteId) throws Exception {
        ...
        Config config = originalConfig.getConfig(EagleConfigConstants.WEB_CONFIG);
        return convertToConfiguraiton(config);
    }

    private Configuration convertToConfiguraiton(Config originalConfig) throws Exception {
