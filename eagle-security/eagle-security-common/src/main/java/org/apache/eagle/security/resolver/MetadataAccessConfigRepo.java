...
public class MetadataAccessConfigRepo {
    ...
    public Configuration getConfig(String datasource, String siteId) throws Exception {
        ...
        GenericServiceAPIResponseEntity ret = resource.search(String.format(queryFormat, datasource, siteId), null, null,Integer.MAX_VALUE, null, false, false, 0L, 0, false, 0, null, false);
