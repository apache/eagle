...
import eagle.security.userprofile.UserProfileMLAlgorithmEvaluator;
import eagle.security.userprofile.model.UserProfileEigenModel;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import java.io.IOException;

import static eagle.security.userprofile.model.UserProfileEigenModelEntity.deserializeModel;
...
public abstract class AbstractUserProfileEigenEvaluator extends UserProfileMLAlgorithmEvaluator<UserProfileEigenModel>{
    ...
    public UserProfileEigenModel convert(MLModelAPIEntity entity) throws IOException {
        try {
            UserProfileEigenModel model = deserializeModel(entity);
