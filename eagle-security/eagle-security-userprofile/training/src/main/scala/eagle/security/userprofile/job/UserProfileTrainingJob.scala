 ...
 */
package eagle.security.userprofile.job

import eagle.security.userprofile.model.{UserProfileModel, UserProfileContext, UserProfileModeler}
import eagle.security.userprofile.sink.{UserActivityAggRDDSink, UserProfileModelRDDSink}
