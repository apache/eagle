...
import eagle.security.userprofile.model.eigen.UserProfileEigenModeler
import eagle.security.userprofile.model.kde.UserProfileKDEModeler
import eagle.security.userprofile.sink.{UserActivityAggKafkaSink, UserProfileHDFSSink, UserProfileEagleServiceSink}
import eagle.security.userprofile.UserProfileJobFactory._
