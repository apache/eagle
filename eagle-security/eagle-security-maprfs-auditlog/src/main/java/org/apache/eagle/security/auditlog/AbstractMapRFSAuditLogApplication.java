 ...
 * Since 8/10/16.
 */
public abstract class AbstractMapRFSAuditLogApplication extends StormApplication {
    ...
    public StormTopology execute(Config config, StormEnvironment environment) {
        ...
        MapRFSAuditLogParserBolt parserBolt = new MapRFSAuditLogParserBolt();
        ...
        StormStreamSink sinkBolt = environment.getStreamSink("mapr_audit_log_stream",config);
