...
public class HdfsTopologyUrlSelector extends AbstractURLSelector {

    public HdfsTopologyUrlSelector(String[] urls, AppConstants.CompressionType compressionType) {
        super(urls, compressionType);
    }

    @Override
    protected String buildTestURL(String urlToCheck) {
        return TopologyResourceURLBuilder.buildHdfsJmxURL(urlToCheck);
    }
}
