...
def compose_commit_msg(commit_msg_file_path, jira_id, pr_title_content, commit_description_lines, author, author_email, reviewer_email_mapping):
...
def generate_commit_msg_file(temp_dir, jira_id, pr_title_content, author, author_email, reviewer_email_mapping):
	...
	compose_commit_msg(commit_msg_file_path, jira_id, pr_title_content, commit_description_lines, author, author_email, reviewer_email_mapping)
	...
	try:
		...
		try:
			...
			if success:
				...
				info("%sthe process is cancelled, and the environment has been recovered" % ("" if user_skip else "failure occurs, "))
			info("Bye.")
