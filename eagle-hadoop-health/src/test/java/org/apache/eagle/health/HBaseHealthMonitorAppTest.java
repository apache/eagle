...
public class HBaseHealthMonitorAppTest extends ApplicationTestBase {
    ...
    public void testApplicationLifecycle() throws InterruptedException {
        ...
        ApplicationOperations.InstallOperation installOperation = new ApplicationOperations.InstallOperation("test_site", "HADOOP_HEALTH_MONITOR", ApplicationEntity.Mode.LOCAL);
